...
* masks are required in all classes and and need to be worn over mouth AND nose at ALL times
* we will do a building check at the beginning of class so please be ready for that
...
notes:
Let's do our first one!  Please have your phone out and face it forward, I'll come around and look

please be aware that this could be the first time folks are on class and might still be working out building access issues (this is my first time doing a check in fact and even teaching in class!) so if folks need to leave because something has gone wrong, its not a big deal and we'll figure it out
...
3-5:50PM Mondays, in person

Jill P. Naiman - `jnaiman@illinois.edu`
 * Office Hours: Tuesdays 10-11am; Thursdays 2-3pm (online)
...
https://uiuc-ischool-dataviz.github.io/is445_spring2022/
...
see: https://uiuc-ischool-dataviz.github.io/is445_spring2022/week01/test_imports_week01.ipynb
 ...
 * Week 10 - Starboard/Observable and Intro to Javascript
 * Week 11 - Viz Audience; More Starboard/Observable, Javascript & Vega-lite (and maybe Idyll)
 * Week 12 - Intro to Idyll
 * Week 13 - More with Idyll, Publishing Viz
 * Week 14 - A few more Idyll+d3 things
...
In addition to the 6 hours of office hours, you should check out the academic support center, in particular the Tutoring by Subject and Skill where you can find Python tutors
...
See the course syllabus: https://uiuc-ischool-dataviz.github.io/is445_spring2022/syllabus.html
 ...
 * [Starboard](https://starboard.gg/) and [Idyll](https://idyll-lang.org/)
 ...
 * Team channel at `https://is445-spring2022.slack.com`
 ...
 * Course repo is at [UIUC-iSchool-DataViz/is445_spring2022/](https://github.com/UIUC-iSchool-DataViz/is445_spring2022/)
 * Automatically built to [uiuc-ischool-dataviz.github.io/is445_spring2022/](https://uiuc-ischool-dataviz.github.io/is445_spring2022/)
